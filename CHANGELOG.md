...
- Upgrade font-awesome to v7.1
- Update README for boostrap version (4 -> 5)
...
- Adjust button for mobile version

## [2.0.11]

### Changed

- Add option to change link text for accordion if opened or closed
- Remove some padding for highlight component inside an accordion on mobile

## [2.0.10]

### Changed

- Update login and logout modal after user testing

## [2.0.8]

### Changed

 - Update login and logout modal
